...
class SliderController extends Controller
{
    ...
    public function updateslider(Request $request){
        ...
        return redirect('/sliders')->with('status', 'The slider has been succesfully updated!');
        ...
        public function activate_slider($id){
            ...
            return back()->with('status', 'The slider has been succesfully activated!');
        ...
        public function unactivate_slider($id){
            ...
            return back()->with('status', 'The slider has been succesfully unactivated!');
    }
}
