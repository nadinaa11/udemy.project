    ...
    public function saveproduct(Request $request) {
       ...
       $this->validate($request, ['product_name' => 'required',
        ...
        public function updateproduct(Request $request){
            ...
            return redirect('/products')->with('status', 'The product has been succesfully updated!');
        ...
        public function activate_product($id){
            ...
            return back()->with('status', 'The product has been succesfully activated!');
        }
        ...
        public function unactivate_product($id){
            ...
            return back()->with('status', 'The product has been succesfully unactivated!');
        }
